...
ingredient_allergen.save()
ingredient_allergen = IngredientAllergen(
    ingredient=jogurt, allergen=mleko_alerg)
ingredient_allergen.save()
ingredient_allergen = IngredientAllergen(
...
ingredient_allergen.save()
ingredient_allergen = IngredientAllergen(
    ingredient=masloOrzechowe, allergen=orzechy_alerg)
ingredient_allergen.save()
ingredient_allergen = IngredientAllergen(
...
kanapkaAwokadoPomidor.save()
kanapkaAwokadoWarzywa = Recipe(name='Kanapki z awokado i warzywami',
                               method='Awokado rozgnieść widelcem i posmarować nim pieczywo. Pomidorki, rzodkiew i ogórka pokroić w plastry i położyć na kanapkach. Doprawić pieprzem do smaku.', calories=200, type='sniadanie')
kanapkaAwokadoWarzywa.save()
...
komosaPomidorki = Recipe(name='Komosa ryżowa z pomidorkami',
                         method='Komosę ryżową ugotować według opisu na opakowaniu, następnie ostudzić. Dodać obraną i pokrojoną marchewkę, pomidorki, pomarańczę, oliwę, sól i pieprz.', calories=250, type='obiad')
komosaPomidorki.save()
...
new_recipeIngredient = RecipeIngredient(
    ingredient=sledz, recipe=sledzCebula, massFraction=0.6)
new_recipeIngredient.save()
new_recipeIngredient = RecipeIngredient(
    ingredient=cebula, recipe=sledzCebula, massFraction=0.15)
new_recipeIngredient.save()
new_recipeIngredient = RecipeIngredient(
...
new_recipeIngredient = RecipeIngredient(
    ingredient=ogorek, recipe=salatkaAwokadoOgorek, massFraction=0.35)
new_recipeIngredient.save()
new_recipeIngredient = RecipeIngredient(
    ingredient=awokado, recipe=salatkaAwokadoOgorek, massFraction=0.2)
new_recipeIngredient.save()
new_recipeIngredient = RecipeIngredient(
    ingredient=szpinak, recipe=salatkaAwokadoOgorek, massFraction=0.25)
new_recipeIngredient.save()
new_recipeIngredient = RecipeIngredient(
    ingredient=suszonePomidory, recipe=salatkaAwokadoOgorek, massFraction=0.2)
new_recipeIngredient.save()

new_recipeIngredient = RecipeIngredient(
    ingredient=salata, recipe=salatkaOliwkiPapryka, massFraction=0.2)
new_recipeIngredient.save()
new_recipeIngredient = RecipeIngredient(
    ingredient=oliwki, recipe=salatkaOliwkiPapryka, massFraction=0.2)
new_recipeIngredient.save()
new_recipeIngredient = RecipeIngredient(
    ingredient=papryka, recipe=salatkaOliwkiPapryka, massFraction=0.25)
new_recipeIngredient.save()
new_recipeIngredient = RecipeIngredient(
    ingredient=mozzarella, recipe=salatkaOliwkiPapryka, massFraction=0.3)
new_recipeIngredient.save()
new_recipeIngredient = RecipeIngredient(
    ingredient=oliwa, recipe=salatkaOliwkiPapryka, massFraction=0.05)
new_recipeIngredient.save()

new_recipeIngredient = RecipeIngredient(
    ingredient=komosa, recipe=komosaPomidorki, massFraction=0.4)
new_recipeIngredient.save()
new_recipeIngredient = RecipeIngredient(
    ingredient=pomidor, recipe=komosaPomidorki, massFraction=0.3)
new_recipeIngredient.save()
new_recipeIngredient = RecipeIngredient(
    ingredient=pomarancza, recipe=komosaPomidorki, massFraction=0.15)
new_recipeIngredient.save()
new_recipeIngredient = RecipeIngredient(
    ingredient=marchew, recipe=komosaPomidorki, massFraction=0.1)
new_recipeIngredient.save()
new_recipeIngredient = RecipeIngredient(
    ingredient=oliwa, recipe=komosaPomidorki, massFraction=0.5)
new_recipeIngredient.save()

new_recipeIngredient = RecipeIngredient(
    ingredient=pieczywo, recipe=kanapkaAwokadoWarzywa, massFraction=0.3)
new_recipeIngredient.save()
new_recipeIngredient = RecipeIngredient(
    ingredient=awokado, recipe=kanapkaAwokadoWarzywa, massFraction=0.25)
new_recipeIngredient.save()
new_recipeIngredient = RecipeIngredient(
    ingredient=pomidor, recipe=kanapkaAwokadoWarzywa, massFraction=0.15)
new_recipeIngredient.save()
new_recipeIngredient = RecipeIngredient(
    ingredient=rzodkiewka, recipe=kanapkaAwokadoWarzywa, massFraction=0.15)
new_recipeIngredient.save()
new_recipeIngredient = RecipeIngredient(
    ingredient=ogorek, recipe=kanapkaAwokadoWarzywa, massFraction=0.15)
new_recipeIngredient.save()

new_recipeIngredient = RecipeIngredient(
    ingredient=pieczywo, recipe=kanapkaAwokadoPomidor, massFraction=0.45)
new_recipeIngredient.save()
new_recipeIngredient = RecipeIngredient(
    ingredient=awokado, recipe=kanapkaAwokadoPomidor, massFraction=0.3)
new_recipeIngredient.save()
new_recipeIngredient = RecipeIngredient(
    ingredient=pomidor, recipe=kanapkaAwokadoPomidor, massFraction=0.25)
new_recipeIngredient.save()

new_recipeIngredient = RecipeIngredient(
    ingredient=pieczywo, recipe=kanapkaPaprykaOgorek, massFraction=0.4)
new_recipeIngredient.save()
new_recipeIngredient = RecipeIngredient(
    ingredient=salata, recipe=kanapkaPaprykaOgorek, massFraction=0.15)
new_recipeIngredient.save()
new_recipeIngredient = RecipeIngredient(
    ingredient=papryka, recipe=kanapkaPaprykaOgorek, massFraction=0.25)
new_recipeIngredient.save()
new_recipeIngredient = RecipeIngredient(
    ingredient=ogorek, recipe=kanapkaPaprykaOgorek, massFraction=0.2)
new_recipeIngredient.save()

new_recipeIngredient = RecipeIngredient(
    ingredient=szpinak, recipe=salatkaAwokadoPieczywo, massFraction=0.2)
new_recipeIngredient.save()
new_recipeIngredient = RecipeIngredient(
    ingredient=pomidor, recipe=salatkaAwokadoPieczywo, massFraction=0.3)
new_recipeIngredient.save()
new_recipeIngredient = RecipeIngredient(
    ingredient=awokado, recipe=salatkaAwokadoPieczywo, massFraction=0.25)
new_recipeIngredient.save()
new_recipeIngredient = RecipeIngredient(
    ingredient=oliwki, recipe=salatkaAwokadoPieczywo, massFraction=0.1)
new_recipeIngredient.save()
new_recipeIngredient = RecipeIngredient(
    ingredient=pieczywo, recipe=salatkaAwokadoPieczywo, massFraction=0.15)
new_recipeIngredient.save()

new_recipeIngredient = RecipeIngredient(
    ingredient=bob, recipe=salatkaZBobem, massFraction=0.35)
new_recipeIngredient.save()
new_recipeIngredient = RecipeIngredient(
    ingredient=kapustaCz, recipe=salatkaZBobem, massFraction=0.25)
new_recipeIngredient.save()
new_recipeIngredient = RecipeIngredient(
    ingredient=salata, recipe=salatkaZBobem, massFraction=0.15)
new_recipeIngredient.save()
new_recipeIngredient = RecipeIngredient(
    ingredient=pomidor, recipe=salatkaZBobem, massFraction=0.25)
new_recipeIngredient.save()

new_recipeIngredient = RecipeIngredient(
    ingredient=cebula, recipe=szakszuka, massFraction=0.2)
new_recipeIngredient.save()
new_recipeIngredient = RecipeIngredient(
    ingredient=czosnek, recipe=szakszuka, massFraction=0.1)
new_recipeIngredient.save()
new_recipeIngredient = RecipeIngredient(
    ingredient=oliwa, recipe=szakszuka, massFraction=0.05)
new_recipeIngredient.save()
new_recipeIngredient = RecipeIngredient(
    ingredient=pomidoryZPuszki, recipe=szakszuka, massFraction=0.35)
new_recipeIngredient.save()
new_recipeIngredient = RecipeIngredient(
    ingredient=jajka, recipe=szakszuka, massFraction=0.3)
new_recipeIngredient.save()
new_recipeIngredient = RecipeIngredient(
