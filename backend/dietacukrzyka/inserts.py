...
new_recipe1.save()
new_recipe2 = Recipe(name = 'Jajecznica na maśle', method = 'Rozpuścić masło na patelni, wbić jaja i wymieszać. Podawać z pieczywem i pokrojonym pomidorem.', calories = 250, type = 'obiad')
new_recipe2.save()
new_recipe3 = Recipe(name = 'Serek wiejski z pomidorem i szczypiorkiem', method = 'Do serka wiejskiego dodać drobno pokrojonego pomidora oraz szczypiorek. Doprawić solą i pieprzem do smaku.', calories = 200, type = 'podwieczorek')
new_recipe3.save()
new_recipe4 = Recipe(name = 'Łosoś pieczony', method = 'Rybę doprawić solą i pieprzem. Wstawić do nagrzanego do 180 stopni piekarnika i piec przez 25 minut. Fasolkę szparagową gotować w osolonej wodzie 12 minut. Podawać z pokrojonym pomidorem.', calories = 300, type = 'kolacja')
new_recipe4.save()
...
new_meal2.save()
new_meal3 = Meal(menu = new_menu, recipe = new_recipe3, calories = 200, date = datetime.date(2020, 10, 12))
new_meal3.save()
new_meal4 = Meal(menu = new_menu, recipe = new_recipe4, calories = 350, date = datetime.date(2020, 10, 12))
new_meal4.save()