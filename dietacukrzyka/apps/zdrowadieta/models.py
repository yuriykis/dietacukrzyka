...
class Dietician(models.Model):
    ...
    last_name = models.CharField(
        "Last Name", default="", max_length=255, null=False)
...
class Ingredient(models.Model):
    ...
    proteins = models.DecimalField(
        "Proteins", max_digits=6, decimal_places=3, default=0, null=False)
    fats = models.DecimalField(
        "Fats", max_digits=6, decimal_places=3, default=0, null=False)
    carbs = models.DecimalField(
        "Carbs", max_digits=6, decimal_places=3, default=0, null=False)
...
class RecipeIngredient(models.Model):
    ...
    massFraction = models.DecimalField(
        "Weight", max_digits=6, decimal_places=3, default=0, null=False)
...
class Menu(models.Model):
    date_from = models.DateField(
        "Name", default=datetime.date.today, null=False)
